  ...
  return (
    <div className="w-full min-h-screen bg-white font-mono">
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <Link
          to="/projectx"
          className="inline-flex items-center gap-2 mb-2 text-black hover:text-blue-600 font-bold group"
        >
          <svg width="28" height="28" fill="none" viewBox="0 0 24 24" className="inline-block group-hover:-translate-x-1 transition">
            <path d="M15 6l-6 6 6 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
          <span className="text-lg underline">Back to Projects</span>
        </Link>
