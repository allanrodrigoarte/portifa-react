...
export default function Cocidade() {
  return (
    <ProjectTemplate
      ...
      images={[
        { src: "/imgs/cocidade/cocidade-center.jpg", alt: "COCIDADE Festival Poster 1" },
        { src: "/imgs/cocidade/cocidade-palco.jpg", alt: "COCIDADE Social Media Graphic" },
        { src: "/imgs/cocidade/cocidade-show.jpg", alt: "Projection Animation Still" },
        { src: "/imgs/cocidade/cocidade-noite.jpg", alt: "Festival Crowd at Anhagabaú" },
      ]}
    />
  );
}
