  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto my-10 px-4">
        ...
        <img
          src="/imgs/cooperapiz/cooperapiz-package.png"
      ...
      <div className="max-w-5xl mx-auto my-10 px-4">
        ...
        <img
          src="/imgs/cooperapiz/zoro-art.png"
          alt="CooperApiz full package key visual"
          className="w-full rounded-lg border border-none shadow-none mb-8"
          loading="lazy"
        />
      ...
      <div className="max-w-5xl mx-auto my-12 px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <img src="/imgs/cooperapiz/terra-zoro.png" alt="Cooperapiz Gallery Image 1" className="rounded-lg bg-white border shadow" loading="lazy" />
          <img src="/imgs/cooperapiz/cooperapiz-tshirt.png" alt="Cooperapiz Gallery Image 2" className="rounded-lg bg-white border shadow" loading="lazy" />
          <img src="/imgs/cooperapiz/cooperapiz-card.png" alt="Cooperapiz Gallery Image 3" className="rounded-lg bg-white border shadow" loading="lazy" />
          <img src="/imgs/cooperapiz/zoro-tribo.jpg" alt="Cooperapiz Gallery Image 1" className="rounded-lg bg-white border shadow" loading="lazy" />
          <img src="/imgs/cooperapiz/zoro-indio.jpg" alt="Cooperapiz Gallery Image 2" className="rounded-lg bg-white border shadow" loading="lazy" />
          <img src="/imgs/cooperapiz/zoro-cocar.jpg" alt="Cooperapiz Gallery Image 3" className="rounded-lg bg-white border shadow" loading="lazy" />
        </div>
      </div>
    </>
  );
