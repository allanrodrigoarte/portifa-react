 ...
 {/* Título principal */}
      ...
      <div className="max-w-5xl mx-auto my-10 px-4">
        <img
          ...
          loading="lazy"
        />
        <h2 className="text-4xl font-extrabold font-mono text-center mt-10 mb-10">Cloud by Printi</h2>
        <img
          src="/imgs/cloudbyprinti.png"  // <-- troque para o nome da sua imagem nova
          alt="Printi Magazine"
          className="w-full rounded-lg border border-none shadow-none"
          loading="lazy"
        />
