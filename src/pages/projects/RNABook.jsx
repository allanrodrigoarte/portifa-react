    ...
    <>
      ...
      <div className="max-w-5xl mx-auto my-12 px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <img src="/imgs/rna/rna1.png" alt="RNA Gallery Image 1" className="rounded-lg bg-white border shadow" loading="lazy" />
          <img src="/imgs/rna/rna2.png" alt="RNA Gallery Image 2" className="rounded-lg bg-white border shadow" loading="lazy" />
          <img src="/imgs/rna/rna3.png" alt="RNA Gallery Image 3" className="rounded-lg bg-white border shadow" loading="lazy" />
        </div>
      </div>
    </>
  );
